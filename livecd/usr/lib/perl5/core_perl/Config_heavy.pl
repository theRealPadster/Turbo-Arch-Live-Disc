...
cf_time='Wed Jan 18 15:49:58 UTC 2012'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg21='-Dlddlflags=-shared -Wl,-O1,--sort-common,--as-needed,-z,relro,--hash-style=gnu'
config_arg22='-Dldflags=-Wl,-O1,--sort-common,--as-needed,-z,relro,--hash-style=gnu'
config_arg2='-Dusethreads'
config_arg3='-Duseshrplib'
config_arg4='-Doptimize=-march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -D_FORTIFY_SOURCE=2'
...
gccansipedantic=''
gccosandvers=''
gccversion='4.6.2 20111223 (prerelease)'
...
ksh=''
ld='cc'
lddlflags='-shared -Wl,-O1,--sort-common,--as-needed,-z,relro,--hash-style=gnu -L/usr/local/lib -fstack-protector'
ldflags='-Wl,-O1,--sort-common,--as-needed,-z,relro,--hash-style=gnu -fstack-protector -L/usr/local/lib'
...
mydomain='.(none)'
myhostname='marin'
myuname='linux marin 3.2.1-1-arch #1 smp preempt fri jan 13 06:50:31 cet 2012 x86_64 intel(r) core(tm) i7 cpu 920 @ 2.67ghz genuineintel gnulinux '
n='-n'
need_va_copy='define'
...
phostname='hostname'
pidtype='pid_t'
plibpth='/lib/x86_64-unknown-linux-gnu/4.6.2 /lib/../lib /usr/lib/x86_64-unknown-linux-gnu/4.6.2 /usr/lib/../lib /lib /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
...
ldflags_nolargefiles='-Wl,-O1,--sort-common,--as-needed,-z,relro,--hash-style=gnu -fstack-protector -L/usr/local/lib'
